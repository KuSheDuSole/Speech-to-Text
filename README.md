...
Запусти скрипт `install_windows.ps1`, он создаст виртуальное окружениие и скачает необходммые зависимости.

Если PowerShell выдает ошибку безопасности, используйте данную коману, чтобы разрешить выполнение скриптов в текущей сессии.
```
